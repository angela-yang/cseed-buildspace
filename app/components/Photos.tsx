...
const photos: PhotoConfig[] = [
  ...
  { src: "/images/cohort-4/img7.jpg",  left: "55%", top: "2vh", size: "clamp(180px, 28vw, 360px)", shape: "circle",  rotate: 0 },
  ...
  { src: "/images/cohort-4/img8.jpg",  left: "15%", top: "1vh", size: "clamp(180px, 28vw, 360px)", shape: "rounded", rotate: 0 },
];
